...
module Tektonlabs
  module Generators
    class ScaffoldGenerator < Base
      ...
      no_tasks { attr_accessor :scaffold_name, :model_attributes, :controller_actions, :ids }
      ...
      def initialize(*args, &block)
        ...
        last=(Access.all.empty? ? 0 : Access.last.id)
        @ids=  Hash.new
        puts args_for_c_m
        ...
        template 'seed.rb', "db/seeds/#{model_path}_access.seeds.rb"
      ...
      def create_controller
        unless options.skip_controller?
          ...
          if buttons_partial?
            template "views/#{view_language}/_buttons.html.#{view_language}", "app/views/#{plural_name}/_buttons.html.#{view_language}"
          end
      ...
      def create_translation
        template 'locales/es.yml', "config/locales/views/#{plural_name}/es.yml"
        template 'locales/en.yml', "config/locales/views/#{plural_name}/en.yml"
      end
